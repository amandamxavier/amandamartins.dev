  ...
  return (
    ...
    >
      ...
      >
        <h1>Hi there! 👋</h1>
        <p>
          My name is <strong>Amanda</strong>, but you can call me{" "}
          <strong>Mandy</strong>. I am a <strong>Fullstack developer</strong>{" "}
          focused on <strong>frontend</strong> development, and currently based
          in <strong>São Paulo</strong>, <strong>Brazil</strong>.
        </p>
